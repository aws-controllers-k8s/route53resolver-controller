...
const (
	FinalizerString = "finalizers.route53resolver.services.k8s.aws/ResolverQueryLogConfigAssociation"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("resolverquerylogconfigassociations")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.ResolverQueryLogConfigAssociation{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.ResolverQueryLogConfigAssociation),
	}
}
