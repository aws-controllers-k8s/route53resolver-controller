...
// +kubebuilder:rbac:groups=route53resolver.services.k8s.aws,resources=resolverquerylogconfigassociations,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=route53resolver.services.k8s.aws,resources=resolverquerylogconfigassociations/status,verbs=get;update;patch
