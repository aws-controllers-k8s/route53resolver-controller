...
var (
	...
	_ = strings.ToLower("")
	_ = &svcsdk.Client{}
	_ = &svcapitypes.ResolverRuleAssociation{}
...
func (rm *resourceManager) sdkCreate(
	...
	var resp *svcsdk.AssociateResolverRuleOutput
	_ = resp
	resp, err = rm.sdkapi.AssociateResolverRule(ctx, input)
	rm.metrics.RecordAPICall("CREATE", "AssociateResolverRule", err)
	if err != nil {
		return nil, err
	}
	// Merge in the information we read from the API call above to the copy of
...
func (rm *resourceManager) newCreateRequestPayload(
	ctx context.Context,
	r *resource,
) (*svcsdk.AssociateResolverRuleInput, error) {
	res := &svcsdk.AssociateResolverRuleInput{}

	if r.ko.Spec.Name != nil {
		res.Name = r.ko.Spec.Name
	}
	if r.ko.Spec.ResolverRuleID != nil {
		res.ResolverRuleId = r.ko.Spec.ResolverRuleID
	}
...
func (rm *resourceManager) sdkDelete(
	...
	var resp *svcsdk.DisassociateResolverRuleOutput
	_ = resp
	resp, err = rm.sdkapi.DisassociateResolverRule(ctx, input)
	rm.metrics.RecordAPICall("DELETE", "DisassociateResolverRule", err)
	return nil, err
}
...
func (rm *resourceManager) newDeleteRequestPayload(
	r *resource,
) (*svcsdk.DisassociateResolverRuleInput, error) {
	res := &svcsdk.DisassociateResolverRuleInput{}
