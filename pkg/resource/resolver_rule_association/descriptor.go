...
const (
	FinalizerString = "finalizers.route53resolver.services.k8s.aws/ResolverRuleAssociation"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("resolverruleassociations")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.ResolverRuleAssociation{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.ResolverRuleAssociation),
	}
}
