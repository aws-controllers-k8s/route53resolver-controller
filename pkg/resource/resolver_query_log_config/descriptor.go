...
const (
	FinalizerString = "finalizers.route53resolver.services.k8s.aws/ResolverQueryLogConfig"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("resolverquerylogconfigs")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.ResolverQueryLogConfig{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.ResolverQueryLogConfig),
	}
}
