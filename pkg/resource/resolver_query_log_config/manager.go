...
// +kubebuilder:rbac:groups=route53resolver.services.k8s.aws,resources=resolverquerylogconfigs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=route53resolver.services.k8s.aws,resources=resolverquerylogconfigs/status,verbs=get;update;patch
...
func (rm *resourceManager) IsSynced(ctx context.Context, res acktypes.AWSResource) (bool, error) {
	...
	statusCandidates := []string{"CREATED"}
